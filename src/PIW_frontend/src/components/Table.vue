                    ...
                    <table class="table-auto min-w-full rounded-xl">
                        ...
                        <tbody class="divide-y divide-gray-300 ">
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Louis
                                    Vuitton</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010510
                                </td>
                                <td class=" px-5 py-3">
                                    <div class="w-48 flex items-center gap-3">
                                        ...
                                        <div class="data">
                                            ...
                                            <p class="font-normal text-xs leading-5 text-gray-400">
                                                floydmiles@pagedone.io </p>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Customer
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    Accessories</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jun. 24,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $18,500
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> United
                                    States </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Apple
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010511
                                </td>
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Feb. 23,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $50,00
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> France
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Johnson
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010512
                                </td>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="data min-w-[150px]">
                                            <p class="font-normal text-sm text-gray-900 whitespace-nowrap">Cameron
                                                Williamson</p>
                                            <p class="font-normal text-xs leading-5 text-gray-400 whitespace-nowrap">
                                                cameron@pagedone.io </p>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Customer
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Oct. 23,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $108,500
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Germany
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                    Starbucks</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010513
                                </td>
                                <td class="w-48 px-5 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="data">
                                            ...
                                            <p class="font-normal text-xs leading-5 text-gray-400">
                                                darrellstew@pagedone.io </p>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Reseller
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Retail
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jul. 12,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $8,500
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> United
                                    Kingdom </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Disney
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010514
                                </td>
                                <td class="w-48 px-5 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="data">
                                            ...
                                            <p class="font-normal text-xs leading-5 text-gray-400">
                                                laurabran@pagedone.io </p>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Reseller
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Finance
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Sep. 29,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $1,500
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Poland
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div
                                        class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                    Mitsubishi</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010515
                                </td>
                                <td class="w-48 px-5 py-3">
                                    <div class="flex items-center gap-3">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    Entertainment</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Dec. 02,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $18,500
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Italy
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div
                                        class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010516
                                </td>
                                <td class="w-48 px-5 py-3 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    Electronics</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Jan. 09,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $50,00
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Germany
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010517
                                </td>
                                <td class="w-48 px-5 py-3">
                                    <div class="flex items-center gap-3">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Banking
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Mar. 15,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $55,000
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> United
                                    States </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> Dell
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20010518
                                </td>
                                <td class="w-48 px-5 py-3 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    Manufacturing</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Apr. 02,
                                    2023 </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> $99,999
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> France
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
