                        ...
                        <li>
                            <figure
                                ...
                                <blockquote class="relative p-3">
                                    <p class="text-6xl font-bold tracking-tight text-slate-900 dark:text-white">98%</p>
                                </blockquote>
                                <figcaption class="text-center">
                                    <div class="font-display text-slate-900 dark:text-white"> ✅ faster than a
                                        traditional editor </div>
                                </figcaption>
                            </figure>
                        </li>
                    </ul>
                    ...
                    <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                        <li>
                            <figure
                                class="relative rounded-2xl bg-white dark:bg-gray-900 p-6 text-center shadow-xl shadow-slate-900/10">
                                <blockquote class="relative p-3">
                                    <p class="text-6xl font-bold tracking-tight text-slate-900 dark:text-white">85%</p>
                                </blockquote>
                                <figcaption class="text-center">
                                    <div class="font-display text-slate-900 dark:text-white">💰 more affordable than a
                                        traditional editor
                                    </div>
                                </figcaption>
                            </figure>
                    ...
                    <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                        <li>
                            <figure
                                class="relative rounded-2xl bg-white dark:bg-gray-900 p-6 text-center shadow-xl shadow-slate-900/10">
                                <blockquote class="relative p-3">
                                    <p class="text-6xl font-bold tracking-tight text-slate-900 dark:text-white">120%</p>
                                </blockquote>
                                <figcaption class="text-center">
                                    <div class="font-display text-slate-900 dark:text-white">😎 increased efficiency and
                                        features</div>
                                </figcaption>
                            </figure>
                        </li>
