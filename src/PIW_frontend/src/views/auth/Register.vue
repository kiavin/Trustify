                        ...
                        <div class="row g-0">
                            <div class="col-12 col-md-6">
                                <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                                    src="/login.jpg" alt="Welcome back you've been missed!">
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="d-flex gap-3 flex-column">
                                                    <RouterLink to="https://identity.ic0.app/" class="btn btn-lg btn-outline-dark">
                                                        ...
                                                        <span class="ms-2 fs-6">Log in Internet Identity</span>
                                                    </RouterLink>
                                                </div>
                                                <div class="d-flex gap-3 flex-column">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" name="lastName"
                                                            id="lastName" placeholder="First Name" required>
