...
<div class="py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style="background-image:url('/cr1.png')">
        </div>
        <div class="w-full p-8 lg:w-1/2">
            ...
            <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <button @click="loginWithInternetIdentity" class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Sign in with Internet Identity</button>
            </a>
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <RouterLink to="/auth/Register" class="text-xs text-gray-500 uppercase">or sign up</RouterLink>
                <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
            <div class="mt-4 flex items-center justify-between">
                <span class="border-b w-1/5 md:w-1/4"></span>
                <RouterLink to="/" class="text-xs text-gray-500 uppercase"> <- Go back</RouterLink>
                <span class="border-b w-1/5 md:w-1/4"></span>
            </div>
        </div>
    </div>
